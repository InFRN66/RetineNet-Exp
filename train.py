...
def main():
	...
	parser.add_argument('--batch_size', help='batch size for train loader', type=int, default=8)
	parser.add_argument('--eval_batch_size', help='batch size for eval loader', type=int, default=8)
	parser.add_argument('--nw', help='num workers for dataloader', type=int, default=8)
	...
	dataloader_train = DataLoader(dataset_train, num_workers=args.nw, collate_fn=collater, batch_sampler=sampler)

	if dataset_val is not None:
		sampler_val = AspectRatioBasedSampler(dataset_val, batch_size=args.eval_batch_size, drop_last=False)
		dataloader_val = DataLoader(dataset_val, num_workers=args.nw, collate_fn=collater, batch_sampler=sampler_val)
