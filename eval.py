...
def main(args=None):
	...
	if args.dataset == 'coco':
		...
		dataset_val = CSVDataset(train_file=args.csv_train, class_list=args.csv_classes, transform=transforms.Compose([Normalizer(), Resizer()]))
	else:
	...
	retinanet.load_state_dict(weight)
	...
	# 		idxs = np.where(scores.data.cpu().numpy()>0.5)
